...
namespace MVC_Demo.wwwroot
{
    public class DepartmentsController : Controller
    {
        private readonly DbContextDemo _context;

        public DepartmentsController(DbContextDemo context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'DbContextDemo.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbContextDemo.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
